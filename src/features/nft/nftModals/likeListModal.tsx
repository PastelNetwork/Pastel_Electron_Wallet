...
const LikeListModal: React.FC<TLikeListModal> = ({
  title,
  content,
  isOpen,
  handleClose,
}) => {
  const [sortName, setSortName] = React.useState<TSortColumn>('date')
  const [direction, setDirection] = React.useState<TSortOption>(null)
